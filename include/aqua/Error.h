...
namespace aqua {
	enum class Error {
		...
		VULKAN_FAILED_TO_CREATE_DEBUG_MESSENGER,
		VULKAN_FAILED_TO_CREATE_SURFACE,
		VULKAN_FAILED_TO_CREATE_LOGICAL_DEVICE,
		...
		VULKAN_FAILED_TO_ENUMERATE_SWAPCHAIN_IMAGES,

		VULKAN_FAILED_TO_ACQUIRE_GPU_SURFACE_CAPABILITIES,
		VULKAN_FAILED_TO_ACQUIRE_GPU_SURFACE_FORMATS,
		VULKAN_FAILED_TO_ACQUIRE_GPU_PRESENT_MODES,
		VULKAN_FAILED_TO_ACQUIRE_QUEUE_FAMILY_PRESENT_SUPPORT,

		VULKAN_NO_AVAILABLE_GPU_FOUND,
		VULKAN_NO_AVAILABLE_GPU_EXTENSIONS_FOUND,
		VULKAN_NO_AVAILABLE_QUEUE_FAMILIES_FOUND,

		VULKAN_NO_SUITABLE_GPU_FOUND,
		VULKAN_NO_SUITABLE_QUEUE_FAMILIES_FOUND,
